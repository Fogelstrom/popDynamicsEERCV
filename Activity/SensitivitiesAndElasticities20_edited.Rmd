...
The general question for a sensitivity analysis is how a very small change in a particular matrix element affects the population growth rate $\lambda$. You'll find that a changes to some matrix elements have a large impact on $\lambda$, whereas changes to other matrix elements do not influence $\lambda$ significantly.  
